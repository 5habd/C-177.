...
stories = [
    ...
    },
    {
        ...
        "inputs": 7,
        "title": "Picnic Time",
        "story": 'On <span class="rep_input">_____</span> we are going on a picnic! I am going with my <span class="rep_input">_____</span> and my favourite pet <span class="rep_input">_____</span>. For lunch, we will eat <span class="rep_input">_____</span> and drink <span class="rep_input">_____</span>. We will end the day with a <span class="rep_input">_____</span> game of <span class="rep_input">_____</span>.',
